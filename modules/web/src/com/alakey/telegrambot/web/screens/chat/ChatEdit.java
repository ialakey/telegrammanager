...
@UiController("telegrambot_Chat.edit")
@UiDescriptor("chat-edit.xml")
@EditedEntityContainer("chatDc")
@LoadDataBeforeShow
public class ChatEdit extends StandardEditor<Chat> {
    ...
    @Inject
    private TextField<String> chatIdField;
    @Inject
    private TextField<String> botTokenField;
    @Inject
    private TextField<String> nameField;
    @Inject
    private TextField<String> descriptionField;
    @Inject
    private TextField<String> chatMembersCountField;
    @Inject
    ...
    @Subscribe("changeAvatarBtn")
    public void onChangeAvatarBtnClick(Button.ClickEvent event) {
        telegramChannelService.setPhoto(getEditedEntity());
    }
    ...
    @Subscribe("getNameTelegramChannelBtn")
    public void onGetNameTelegramChannelBtnClick(Button.ClickEvent event) {
        if (chatIdField.getValue() != null && botTokenField.getValue() != null) {
            ChatDTO chatDTO = telegramChannelService.getInfoTgChannel(chatIdField.getValue(), botTokenField.getValue());
            nameField.setValue(chatDTO.getName());
            descriptionField.setValue(chatDTO.getDescription());
            chatMembersCountField.setValue(chatDTO.getChatMembersCount());
        }
    }
}